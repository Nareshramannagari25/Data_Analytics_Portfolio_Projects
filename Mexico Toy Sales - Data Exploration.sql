					...
					/* Skills Used : Aggregate Functions, Case Statements, Joins, Sub Queries, CTE's, Indexes, Views, Procedures, 
					                 Window Functions, In-Built Functions, Clauses like : DISTINCT, WHERE, GROUP BY, ORDER BY, OFFSET, FETCH  */
